			...
			<div class="secion-detail">
				<ul class="list-item clearfix">
					...
					<c:forEach var="item" items="${ CatId }">
						<li><a href="/i8-web/danh-sach-san-pham" title="">${item.name }</a>
						</li>
					</c:forEach>
				</ul>
			</div>
			...
			<div class="section" id="list-product-wp">
				<div class="section-head clearfix">
					...
					<div class="filter-wp fl-right">
						<p class="desc">Có ${listProduct.size() } sản phẩm</p>
						<div class="form-filter">
							<form method="POST" action="">
								<select id="common_selector">
									...
									<option value="3" class="filter_order">Giá cao xuống
										thấp</option>
									<option value="4" class="filter_order">Giá thấp lên
										cao</option>
								</select>
							</form>
						</div>
				...
				<div class="section-detail">
					<ul class="list-item clearfix list-filter">
						<c:forEach var="item" items="${ listProduct }">
							...
							</a> <a href="/i8-web/chi-tiet-san-pham/${item.slug }?id=${item.id }"
				...
				<div class="section-detail">
					<form method="POST" action="">
						<table>
							...
							<tbody>
								<tr>
									<td><input type="radio" class="common_selector price_new" name="price_new"
										checked value="all"></td>
									<td>Tất cả</td>
								</tr>
								<tr>
									<td><input type="radio" class="common_selector price_new"
										name="price_new" value="500000"></td>
									<td>Dưới 500.000đ</td>
								</tr>
								<tr>
									<td><input type="radio" class="common_selector price_new"
										name="price_new" value="500000 AND 1000000"></td>
									<td>500.000đ - 1.000.000đ</td>
								</tr>
								<tr>
									<td><input type="radio" class="common_selector price_new"
										name="price_new" value="1000000 AND 5000000"></td>
									<td>1.000.000đ - 5.000.000đ</td>
								</tr>
								<tr>
									<td><input type="radio" class="common_selector price_new"
										name="price_new" value="5000000 AND 10000000"></td>
									<td>5.000.000đ - 10.000.000đ</td>
								</tr>
								<tr>
									<td><input type="radio" class="common_selector price_new"
										name="price_new" value="10000000"></td>
